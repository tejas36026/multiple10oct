self.onmessage = function(e) {
    ...
    for (let i = 0; i < totalIterations; i++) {
        ...
        applyDiagonalEffectUpRight(imageData, newImageData, selectedRegions, width, height, horizontalOffset, verticalOffset);
...
function applyDiagonalEffectUpRight(sourceImageData, targetImageData, selectedRegions, width, height, horizontalOffset, verticalOffset) {
