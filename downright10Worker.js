self.onmessage = function(e) {
    ...
    for (let i = 0; i < totalIterations; i++) {
        ...
        applyDiagonalEffectDownRight(imageData, newImageData, selectedRegions, width, height, horizontalOffset, verticalOffset);
...
function applyDiagonalEffectDownRight(sourceImageData, targetImageData, selectedRegions, width, height, horizontalOffset, verticalOffset) {
