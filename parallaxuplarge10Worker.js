self.onmessage = function(e) {
    ...
    // Function to clone and move the selected region upwards and make it 0.005% larger from the center
    function cloneAndMoveRegion(imageData, selectedRegion, shiftAmount, scaleFactor) {
        ...
        selectedRegion.forEach(pixelIndex => {
            ...
            const newX = Math.floor((x - centerX) * scaleFactor + newCenterX);
            const newY = Math.floor((y - centerY) * scaleFactor + newCenterY - shiftAmount);
